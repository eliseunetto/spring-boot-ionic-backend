...
import com.eliseunetto.cursomc.domain.Endereco;
import com.eliseunetto.cursomc.domain.Estado;
import com.eliseunetto.cursomc.domain.ItemPedido;
import com.eliseunetto.cursomc.domain.Pagamento;
import com.eliseunetto.cursomc.domain.PagamentoComBoleto;
import com.eliseunetto.cursomc.domain.PagamentoComCartao;
...
import com.eliseunetto.cursomc.domain.enums.Perfil;
import com.eliseunetto.cursomc.domain.enums.TipoCliente;
import com.eliseunetto.cursomc.repositories.CategoriaRepository;
import com.eliseunetto.cursomc.repositories.CidadeRepository;
import com.eliseunetto.cursomc.repositories.ClienteRepository;
import com.eliseunetto.cursomc.repositories.EnderecoRepository;
import com.eliseunetto.cursomc.repositories.EstadoRepository;
import com.eliseunetto.cursomc.repositories.ItemPedidoRepository;
import com.eliseunetto.cursomc.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "easntec@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Anna Costa", "eliseu.netto@gmail.com", "41626124124", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("32324455", "912345678"));
